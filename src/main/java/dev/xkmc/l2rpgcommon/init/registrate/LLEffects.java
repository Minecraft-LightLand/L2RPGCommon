...
import dev.xkmc.l2rpgcommon.content.assassin.effect.TargetAttractedEffect;
import dev.xkmc.l2rpgcommon.content.assassin.effect.TargetAttractorEffect;
import dev.xkmc.l2rpgcommon.content.assassin.effect.TargetHideEffect;
import dev.xkmc.l2rpgcommon.content.assassin.effect.TargetRemoveEffect;
import dev.xkmc.l2rpgcommon.content.common.effect.ArmorReduceEffect;
import dev.xkmc.l2rpgcommon.content.common.effect.CleanseEffect;
import dev.xkmc.l2rpgcommon.content.common.effect.DispellEffect;
import dev.xkmc.l2rpgcommon.content.common.effect.EmeraldPopeEffect;
import dev.xkmc.l2rpgcommon.content.common.effect.force.*;
import dev.xkmc.l2rpgcommon.content.common.effect.skill.*;
...
public class LLEffects {
	...
	public static void registerBrewingRecipe() {
		PotionBrewing.addMix(Potions.AWKWARD, LLItems.CLEANSE_WATER_BOTTLE.get(), P_CLEANSE_WATER.get());
		PotionBrewing.addMix(P_CLEANSE_WATER.get(), Items.REDSTONE, P_CLEANSE_WATER_L.get());
		PotionBrewing.addMix(P_CLEANSE_WATER.get(), LLItems.DISPELL_DUST.get(), P_DISPELL.get());
		PotionBrewing.addMix(P_CLEANSE_WATER_L.get(), LLItems.DISPELL_DUST.get(), P_DISPELL_L.get());
