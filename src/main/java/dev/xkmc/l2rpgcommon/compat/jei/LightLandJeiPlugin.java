package dev.xkmc.l2rpgcommon.compat.jei;

import dev.xkmc.l2library.util.Proxy;
import dev.xkmc.l2rpgcommon.compat.jei.ingredients.ElemIngredientHelper;
import dev.xkmc.l2rpgcommon.compat.jei.ingredients.ElemIngredientRenderer;
import dev.xkmc.l2rpgcommon.compat.jei.ingredients.ElementIngredient;
import dev.xkmc.l2rpgcommon.compat.jei.recipes.DisEnchanterRecipeCategory;
import dev.xkmc.l2rpgcommon.compat.jei.recipes.MagicCraftRecipeCategory;
import dev.xkmc.l2rpgcommon.compat.jei.screen.ExtraInfoScreen;
import dev.xkmc.l2rpgcommon.content.magic.gui.craft.ArcaneInjectScreen;
import dev.xkmc.l2rpgcommon.content.magic.gui.craft.DisEnchanterScreen;
