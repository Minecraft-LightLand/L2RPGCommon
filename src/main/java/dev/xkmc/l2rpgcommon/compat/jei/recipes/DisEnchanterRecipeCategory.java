package dev.xkmc.l2rpgcommon.compat.jei.recipes;

import dev.xkmc.l2library.base.recipe.BaseRecipeCategory;
import dev.xkmc.l2rpgcommon.compat.jei.LightLandJeiPlugin;
...
public class DisEnchanterRecipeCategory extends BaseRecipeCategory<IMagicRecipe, DisEnchanterRecipeCategory> {
	...
	public Component getTitle() {
		return LangData.translate(LightlandMenu.getLangKey(LightlandMenu.MT_DISENC.get()));
	}
