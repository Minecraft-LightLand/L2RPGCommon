package dev.xkmc.l2rpgcommon.content.common.gui;
...
public abstract class AbstractAbilityScreen extends Screen {
	...
	public enum AbilityTab {
		...
		ELEMENT(2, () -> LMItems.MAGIC_WAND.get().getDefaultInstance(), ElementalScreen::canAccess, ElementalScreen::new, ElementalScreen.TITLE),
		ARCANE(3, () -> LMItems.ARCANE_AXE_GILDED.get().getDefaultInstance(), ArcaneScreen::canAccess, ArcaneScreen::new, ArcaneScreen.TITLE);
